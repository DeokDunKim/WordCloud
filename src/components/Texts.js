...
class Texts extends React.Component {
    ...
    _get() {
        fetch('https://word-cloud-b1d4a.firebaseio.com/texts.json', { mode: "cors" }).then(res => {
            if(res.status != 200) {
    ...
    _post(text) {
        fetch('https://word-cloud-b1d4a.firebaseio.com/texts.json', {
            method: 'POST',
    ...
    _delete(id) {
        fetch('https://word-cloud-b1d4a.firebaseio.com/texts/' + id + '.json', {
            method: 'DELETE'
        }).then(res => {
            if(res.status != 200) {
                throw new Error(res.statusText);
